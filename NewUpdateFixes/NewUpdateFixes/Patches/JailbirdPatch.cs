...
namespace NewUpdateFixes.Patches
{
    ...
    public static class JailbirdPatch
    {
        public static void EnableEffect(HitboxIdentity hitboxIdentity)
        {
            ...
            val.EnableEffect(NewUpdateFixes.Instance.Config.JailbirdEffect, NewUpdateFixes.Instance.Config.JailbirdEffectIntensity, NewUpdateFixes.Instance.Config.JailbirdEffectDuration, true);
